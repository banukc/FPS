...
/*  MORPHO PK FORMAT  */
/*****************************************************************************/
 #define	MORPHO_PK_COMP 0 		//0x02
 #define        MORPHO_PK_MAT_NORM 3 		//0x35
 #define        MORPHO_PK_COMP_NORM 1 		//37
 #define        MORPHO_PK_MAT 	2         	//0x03
 #define        MORPHO_PK_ANSI_378 65    	// 0x41
 #define        MORPHO_PK_MINEX_A  111   	// 0x6f
 #define        MORPHO_PK_ISO_FMR  110   	// 0x6e
 #define        MORPHO_PK_ISO_FMC_NS 109 	// 0x6d
 #define        MORPHO_PK_ISO_FMC_CS  108	// 0x6c
 #define        MORPHO_PK_ILO_FMR    107   	// 0x6b
 #define	MORPHO_PK_PKLITE    204   	// 0xcc
 #define	MORPHO_PK_CFV       196  	// 0xc4
...
typedef I  (*T_MORPHO_CALLBACK_FUNCTION)(
                          ...
                          T_MORPHO_CALLBACK_COMMAND       i_i_command,  ///< Asynchronous command types
...
typedef enum {
                MORPHO_PK_COMP, //0x02
                MORPHO_PK_MAT_NORM,//0x35
                MORPHO_PK_COMP_NORM, //37
                MORPHO_PK_MAT,//0x03
                MORPHO_PK_ANSI_378=0x41,
                MORPHO_PK_MINEX_A=0x6f,
                MORPHO_PK_ISO_FMR=0x6e,
                MORPHO_PK_ISO_FMC_NS=0x6d,
                MORPHO_PK_ISO_FMC_CS=0x6c,
               MORPHO_PK_ILO_FMR=0x6b,
		MORPHO_PK_PKLITE=0xcc,
		MORPHO_PK_CFV=0xc4
